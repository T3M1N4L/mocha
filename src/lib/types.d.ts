...
declare global {
  interface Window {
    ...
    // Scramjet loader available when bundle is loaded dynamically
    $scramjetLoadController?: () => {
      ScramjetController: new (opts?: any) => any;
    };

    // Optional globals exposed by proxy setup for plugin control
    RefluxControlAPI?: any;
    RefluxAPIInstance?: any;
  }
}
